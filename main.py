...
- `amoblado`: 'Sí' si aparece amoblado/amueblado/equipado; 'No' si explícitamente dice sin amoblar; si ambiguo, usa null.
...

{
  ...
  "ubicacion": "dirección formateada estilo Google Maps si consta; si solo hay zona/barrio, deja null y usa 'Barrio'/'barrioasu'" (string|null)
}
